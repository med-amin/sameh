...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'daisy-store' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'daisy-store' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'daisy-store' ),
		'cyrillic'     => __( 'Cyrillic', 'daisy-store' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'daisy-store' ),
		'devanagari'   => __( 'Devanagari', 'daisy-store' ),
		'greek'        => __( 'Greek', 'daisy-store' ),
		'greek-ext'    => __( 'Greek Extended', 'daisy-store' ),
		'khmer'        => __( 'Khmer', 'daisy-store' ),
		'latin'        => __( 'Latin', 'daisy-store' ),
		'latin-ext'    => __( 'Latin Extended', 'daisy-store' ),
		'vietnamese'   => __( 'Vietnamese', 'daisy-store' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'daisy-store' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'daisy-store' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'daisy-store' ),
