<?php
	$categories_menu_toggle_text = daisy_store_option('categories_menu_toggle_text');
?>
	<div class="cactus-cate-menu-wrap">
		...
		<?php
			...
			$expand_menu = get_post_meta($postid , 'daisy_store_expand_menu', true);
			
			
			$expand_menu = apply_filters( 'daisy_store_expand_menu', $expand_menu );
